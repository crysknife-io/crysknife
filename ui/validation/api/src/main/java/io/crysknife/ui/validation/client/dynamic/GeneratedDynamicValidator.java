 ...
 *
 * @param <T> The type of value validated by this generated validator.
 *
...
public interface GeneratedDynamicValidator<T> {
   ...
   * @return An empty set if the given value is valid, or as set with one or more
   *         {@link ConstraintViolation ConstraintViolations} if given value is invalid.
   */

...
public enum StateSync {
  ...
  /**
   * Specifies that the bound value should be initialized to the pre-existing value in the UI
   * widget.
   */
  FROM_UI {
    @Override
   ...
   * 
   * @param modelValue The pre-existing model value.
   * @param widgetValue The pre-existing UI widget value.
   * 
   * @return Either model or widget. Return value will be null if the corresponding parameter value
   *         is null.
   */

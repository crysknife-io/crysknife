...
/**
 * Thrown to indicate that a JavaBean property does not exist on the object it was referred to. This
 * exception is thrown by implementations of {@link HasProperties} (e.g proxies for {@link Bindable}
 * types).
 *

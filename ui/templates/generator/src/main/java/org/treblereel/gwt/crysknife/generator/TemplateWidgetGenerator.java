...
public class TemplateWidgetGenerator {
    ...
    TemplateWidgetGenerator build(boolean isGWT2) {
        ...
        clazz.append("/*\n" +
                ...
                .append("import org.treblereel.gwt.crysknife.templates.client.annotation.Templated;\n" +
                                "\n" +
                                "/**\n" +
    ...
    void generate() {
        ...
        try {
            builderFile = iocContext.getGenerationContext()
                    ...
                    .getFiler()
                    .createSourceFile("org.treblereel.gwt.crysknife.templates.client.TemplateWidget");

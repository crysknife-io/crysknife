...
/**
 * Contract for converters that perform model value to component value transformations and vice
 * versa.
 *
 ...
 * @param <C> The type of the component value (e.g. String for a {@link TextBox}
...
public interface Converter<M, C> {
   ...
   *
   * @param componentValue the component value to convert, may be null.
   * 
  ...
  /**
   * Converts the provided model value to a value usable by widgets of type {@link HasValue
   * HasValue&lt;W&gt;} or {@link TakesValue TakesValue&lt;W&gt;}.
   *
   * @param modelValue the model value to convert, may be null.
   * 

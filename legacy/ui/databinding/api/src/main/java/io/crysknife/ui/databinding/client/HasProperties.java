 ...
 * Since this is a GWT client-side interface, all implementations must be code generated in the
 * absence of Java reflection.
 * 
...
public interface HasProperties {
   ...
   * 
   * @param propertyName the name of the JavaBean property, must not be null.
   * 
   * @return the current value of the corresponding property.
   * 
   * @throws NonExistingPropertyException if the implementing bean does not have a property with the
   *         given name.
   */

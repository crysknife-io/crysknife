 ...
 * <p>
 * The widgets are inferred from all enclosing fields and methods annotated with
 * {@link org.jboss.errai.ui.shared.api.annotations.Bound} of the class that defines the
 * {@link Model} and all its super classes.
 * <p>
 * The annotated model can be a field and a method or constructor parameter. The following example

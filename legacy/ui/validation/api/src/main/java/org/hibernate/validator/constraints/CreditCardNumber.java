...
/**
 * The annotated element has to represent a valid credit card number. This is the Luhn algorithm
 * implementation which aims to check for user mistake, not credit card validity!
 *

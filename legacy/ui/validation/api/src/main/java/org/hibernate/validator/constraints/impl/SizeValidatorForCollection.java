...
public class SizeValidatorForCollection implements ConstraintValidator<Size, Collection> {
   ...
   *
   * @return Returns <code>true</code> if the collection is <code>null</code> or the number of
   *         entries in <code>collection</code> is between the specified <code>min</code> and
   *         <code>max</code> values (inclusive), <code>false</code> otherwise.
   */
